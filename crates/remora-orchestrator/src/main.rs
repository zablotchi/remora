...
type Protocol = protocol::remora::RemoraProtocol;
type NodeParameters = protocol::remora::RemoraNodeParameters;
type ClientParameters = protocol::remora::RemoraClientParameters;
